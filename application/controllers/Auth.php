...
class auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata(
                'message',
                '<div class="alert alert-success" role="alert">Congratulation! your account has been created. Please activate you account!</div>'
            );
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'uchiyatulhidayah@gmail.com',
            'smtp_pass' => 'orangcakepbebas',
            'smtp_port' => 465,
            'mailtype' => 'html',
            'charset' => 'utf-8',
            'newline' => "\r\n"
        ...
        $this->email->from('Uchi2741@gmail.com', 'Uchiyatul Hidayah');
        ...
        if ($type == 'verify') {
            ...
            $this->email->message('Click this link to reset your password : <a href="' . base_url() .
                'auth/resetpassword?email=' . $this->input->post('email') . '&token=' . urlencode($token) . '">Resey Password</a>');
        }
